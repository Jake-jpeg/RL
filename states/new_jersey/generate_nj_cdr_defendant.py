#!/usr/bin/env python3
"""
DivorceGPT NJ - Defendant's Certification of Notification of
Complementary Dispute Resolution (CDR) Alternatives

Per R. 5:4-2(h). Verbatim required language.
...
def generate_nj_cdr_defendant(data, output_path):
    """
    Generate Plaintiff's CDR Certification.
    ...
    # =====================================================================
    c.setFont(FONT, FONT_SIZE)
    c.drawString(MARGIN_LEFT, y, f"{d_name}, being of full age, hereby certifies as follows:")
    y -= DOUBLE_SPACE * 1.2
    ...
    y = draw_wrapped_justified(c,
        "I am the Defendant in the above captioned matter, and I am not represented by an attorney.",
    ...
    y = draw_wrapped_justified(c,
        ...
        'Divorce or Dissolution - Dispute Resolution Alternatives to Conventional Litigation."',
        para_x, y, para_width, line_height=DOUBLE_SPACE)
    y -= DOUBLE_SPACE * 0.1
    ...
    # =====================================================================
    # SIGNATURE BLOCK — same as Verification Cert
    # =====================================================================
    y -= DOUBLE_SPACE * 2.5
...
if __name__ == "__main__":
    ...
    output = generate_nj_cdr_defendant(test_data, "/tmp/test_nj_cdr_defendant.pdf")
