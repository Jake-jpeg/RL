#!/usr/bin/env python3
"""
DivorceGPT NJ - Defendant's Certification in Support of Judgment of Divorce
...
def generate_nj_jod_cert_defendant(data, output_path):
    """
    Generate Defendant's Certification in Support of JOD Without Court Appearance.
    ...
    # =====================================================================
    c.setFont(FONT, FONT_SIZE)
    c.drawString(MARGIN_LEFT, y, f"I, {d_name}, of full age, hereby certify:")
    y -= DOUBLE_SPACE * 1.2
    ...
    y = draw_wrapped_justified(c,
        "I am the Defendant, and I am filing this Certification in support of my "
    ...
    y = draw_wrapped_justified(c,
        "I have read the Complaint for Divorce filed by the Plaintiff.",
    ...
    y = draw_wrapped_justified(c,
        "I certify to the truth of the Complaint as it pertains to the grounds for divorce.",
        sub_x, y, sub_width, line_height=DOUBLE_SPACE)
    y -= DOUBLE_SPACE * 0.2
    ...
    y = draw_wrapped_justified(c,
        "I filed an Acknowledgment of Service.",
        sub_x, y, sub_width, line_height=DOUBLE_SPACE)
    y -= DOUBLE_SPACE * 0.2
    ...
    y = draw_wrapped_justified(c,
        "I do not want to reconcile with the Plaintiff.",
        sub_x, y, sub_width, line_height=DOUBLE_SPACE)
    y -= DOUBLE_SPACE * 0.3
...
if __name__ == "__main__":
    ...
    output = generate_nj_jod_cert_defendant(test_data, "/tmp/test_nj_jod_cert_defendant.pdf")
