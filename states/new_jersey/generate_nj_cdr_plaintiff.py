#!/usr/bin/env python3
"""
DivorceGPT NJ - Plaintiff's Certification of Notification of
...
def generate_nj_cdr_plaintiff(data, output_path):
    ...
    y = draw_wrapped_justified(c,
        "I am the Plaintiff in the above captioned matter, and I am not represented by an attorney.",
...
if __name__ == "__main__":
    ...
    output = generate_nj_cdr_plaintiff(test_data, "/tmp/test_nj_cdr_plaintiff.pdf")
